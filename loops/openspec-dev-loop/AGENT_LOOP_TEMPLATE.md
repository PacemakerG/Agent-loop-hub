...
- heartbeat 当前间隔：<paused|3 分钟|5 分钟|10 分钟>
...
6. heartbeat 初始状态按当前阶段设置：
   - 如果 Planner 正在工作，设为 3 分钟 ACTIVE。
   - 如果 Executor 正在工作，设为 10 分钟 ACTIVE。
   - 如果 Reviewer 正在工作，设为 5 分钟 ACTIVE。
   - 如果等用户，设为 PAUSED。
...
当你派出：
- Planner：heartbeat 改为 3 分钟
- Executor：heartbeat 改为 10 分钟
- Reviewer：heartbeat 改为 5 分钟
